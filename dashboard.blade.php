...
<main>
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">{{ $todayAttendanceCount ?? 0}}</p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-body-secondary">Today</h6>
                    <p class="card-text">{{$todayPermissionCount ?? 0}}</p>
                    <!-- <a href="#" class="card-link">View</a> -->
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-body-secondary">Today</h6>
                    <p class="card-text">{{$todayLeaveCount ?? 0}}</p>
                    <!-- <a href="#" class="card-link">View</a> -->
                </div>
            </div>
            <div class="card">
        ...
        <table id="myTable" class="table table-striped table-bordered">
            ...
            <tbody>
            @if(isset($attendanceRecords) && !$attendanceRecords->isEmpty())
